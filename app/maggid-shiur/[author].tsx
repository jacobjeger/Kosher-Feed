    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            {item.imageUrl ? (
              <Image source={feedImageSource(item.imageUrl, IMG_CARD)} style={styles.feedImage} contentFit="cover" cachePolicy="memory-disk" recyclingKey={item.id} transition={180} />
            ) : (
