...
const StableArtwork = memo(function StableArtwork({ imageUrl, fallbackColor, iconColor }: { imageUrl?: string | null; fallbackColor: string; iconColor: string }) {
  if (imageUrl) {
    return <Image source={feedImageSource(imageUrl, IMG_HERO)} style={styles.artwork} contentFit="cover" cachePolicy="memory-disk" recyclingKey={imageUrl} transition={180} />;
  }
  return (
