...
import { fetchCarouselImages, fetchAnnouncements, fetchUpcomingEvents, fetchMostRecentShiur } from "@/lib/ytc/firebase";
import type { CarouselImage, Announcement, YtcEvent, Shiur } from "@/types/ytc";
import { useYtcPlay } from "@/lib/ytc/audio-adapter";
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: Colors.navy, paddingHorizontal: 20, paddingVertical: 16 },
  ...
  shiurCard: { flexDirection: "row", backgroundColor: Colors.white, borderRadius: 12, padding: 16, gap: 12, alignItems: "center", shadowColor: Colors.black, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 2 },
  shiurInfo: { flex: 1 },
